...
```
[pc1] .1 === hub(10.2.0.0/24) === .254 fe0/0 [r1] fe0/1 .253 === (10.2.1.0/24) === .254 fe0/0 [r2] fe0/1 .253 === (10.2.2.0/24)  
[pc2] .65
[pc3] .129
[pc4] .193
```
...
以下のクライアントをNAT 対象クライアントとします。
ハブを介して、r1 の fe0/0 に接続します。

| pc | addr/mask | gateway |
| ---- | ---- | ---- |
| pc1 | 10.2.0.1/24 | 10.2.0.254/24 |
| pc2 | 10.2.0.65/24 | 10.2.0.254/24 |
| pc3 | 10.2.0.129/24 | 10.2.0.254/24 |
| pc4 | 10.2.0.193/24 | 10.2.0.254/24 |
